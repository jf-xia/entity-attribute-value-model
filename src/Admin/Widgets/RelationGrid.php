...
class RelationGrid extends Grid
{
    /**
     ...
     * @var string
     */
    protected $view = 'eav::admin.widgets.relation_table';
     ...
     * @var array
     */
    public $perPages = [5, 10, 20, 30, 50, 100];
    ...
    {
        return $this->options['useRowSelector'] ? $this->tools->render() : '';
    }
    ...
    public function setBoxFooter($footer = '')
    {
        return $this->boxFooter = $footer;
    }

    public function renderBoxFooter()
    {
        return $this->boxFooter;
    }
